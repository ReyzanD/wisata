    ...
    <nav class="bg-white shadow-lg sticky top-0 z-50">
        ...
        <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                @auth
                    <a href="{{ route('bookings.index') }}" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-md">Booking Saya</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <!-- Booking Card -->
                <div class="bg-white p-6 rounded-lg shadow-lg border-2 border-blue-200 mb-6 sticky top-20">
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Pesan Kunjungan</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center">
                            <div class="flex items-center mr-2">
                                @for($i = 1; $i <= 5; $i++)
                                    <svg class="w-4 h-4 {{ $i <= $destination->getAverageRating() ? 'text-yellow-400' : 'text-gray-300' }}" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                    </svg>
                                @endfor
                            </div>
                            <span class="text-sm font-semibold text-gray-900">{{ $destination->getAverageRating() }}</span>
                            <span class="text-sm text-gray-600 ml-1">({{ $destination->getReviewCount() }} ulasan)</span>
                        </div>
                        @endif
                    </div>
                    ...
                    @auth
                        <a href="{{ route('bookings.create', $destination->id) }}" class="block w-full bg-blue-600 text-white text-center px-6 py-3 rounded-lg hover:bg-blue-700 font-semibold shadow-md hover:shadow-lg transition">
                        ...
                        <a href="{{ route('bookings.index') }}" class="block w-full text-center text-blue-600 hover:text-blue-700 mt-3 text-sm font-medium">
                            Lihat Booking Saya
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="block w-full bg-blue-600 text-white text-center px-6 py-3 rounded-lg hover:bg-blue-700 font-semibold shadow-md hover:shadow-lg transition">
                            Login untuk Booking
                        </a>
                        <p class="text-xs text-gray-500 text-center mt-3">Belum punya akun? <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700 font-medium">Daftar di sini</a></p>
                    @endauth
                </div>
