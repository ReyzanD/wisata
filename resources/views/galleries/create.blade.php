                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('galleries.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title_232136" class="block mt-1 w-full" type="text" name="title_232136" :value="old('title_232136')" required autofocus />
                            <x-input-error :messages="$errors->get('title_232136')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="image_232136" :value="__('Upload Gambar')" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="url_232136" class="block mt-1 w-full" type="url" name="url_232136" :value="old('url_232136')" />
                            <x-input-error :messages="$errors->get('url_232136')" class="mt-2" />
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Jika tidak upload file, masukkan URL gambar</p>
                        </div>
