                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('reviews.update', $review->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="user_name_232136" class="block mt-1 w-full" type="text" name="user_name_232136" :value="old('user_name_232136', $review->user_name_232136)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="destination_id_232136" name="destination_id_232136" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                ...
                                @foreach($destinations as $destination)
                                    <option value="{{ $destination->id }}" {{ old('destination_id_232136', $review->destination_id_232136) == $destination->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="rating_232136" name="rating_232136" required class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                ...
                                <option value="1" {{ old('rating_232136', $review->rating_232136) == 1 ? 'selected' : '' }}> 1</option>
                                <option value="2" {{ old('rating_232136', $review->rating_232136) == 2 ? 'selected' : '' }}> 2</option>
                                <option value="3" {{ old('rating_232136', $review->rating_232136) == 3 ? 'selected' : '' }}> 3</option>
                                <option value="4" {{ old('rating_232136', $review->rating_232136) == 4 ? 'selected' : '' }}> 4</option>
                                <option value="5" {{ old('rating_232136', $review->rating_232136) == 5 ? 'selected' : '' }}> 5</option>
                            </select>
